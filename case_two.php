...
// Extending the Item class for Fruits
class Fruit extends Item {
    protected $discountRate = 0.5; // 50% discount

    public function getTotalPrice() {
        $totalPrice = parent::getTotalPrice();
        return $totalPrice - ($totalPrice * $this->discountRate); // Apply discount
    }
}
...
// Create items
$banana = new Fruit("Banana", 6, 1, 0.06);
$apple = new Fruit("Apple", 3, 1.5, 0.06);
